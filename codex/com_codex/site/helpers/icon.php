 ...
 *              Use the class \Joomla\Component\Codex\Administrator\Service\HTML\Icon instead
 */
abstract class JHtmlIcon
{
     ...
     *
     * @deprecated  4.3 will be removed in 7.0
     *              Use \Joomla\Component\Codex\Administrator\Service\HTML\Icon::create instead
     *              Example:
     ...
     *
     * @deprecated  4.3 will be removed in 7.0
     *              Use \Joomla\Component\Codex\Administrator\Service\HTML\Icon::edit instead
     *              Example:
     *              use Joomla\Component\Codex\Administrator\Service\HTML\Icon;
     *              Factory::getContainer()->get(Registry::class)->register('icon', new Icon());
    ...
    {
        throw new \Exception(Text::_('COM_CODEX_ERROR_PRINT_POPUP'));
    }
     ...
     *
     * @deprecated  4.3 will be removed in 7.0
     *              Use \Joomla\Component\Codex\Administrator\Service\HTML\Icon::print_screen instead
     *              Example:
     *              use Joomla\Component\Codex\Administrator\Service\HTML\Icon;
     *              Factory::getContainer()->get(Registry::class)->register('icon', new Icon());
     ...
     *
     * @return  \Joomla\Component\Codex\Administrator\Service\HTML\Icon
     *
     * @deprecated  4.3 will be removed in 7.0 without replacement
     */
    private static function getIcon()
    {
        return new \Joomla\Component\Codex\Administrator\Service\HTML\Icon(Joomla\CMS\Factory::getApplication());
    }
}
