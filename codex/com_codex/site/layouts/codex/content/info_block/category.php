...
<dd class="category-name">
    <?php echo LayoutHelper::render('codex.icon.iconclass', ['icon' => 'icon-folder-open icon-fw']); ?>
    ...
    <?php if ($displayData['params']->get('link_category') && !empty($displayData['item']->catid)) : ?>
        <?php $url = '<a href="' . Route::_(
            ...
            . '">' . $title . '</a>'; ?>
        <?php echo Text::sprintf('COM_CODEX_CATEGORY', $url); ?>
    <?php else : ?>
        <?php echo Text::sprintf('COM_CODEX_CATEGORY', '<span>' . $title . '</span>'); ?>
    <?php endif; ?>
</dd>
