...
$document->getWebAssetManager()
    ...
    ->registerAndUseStyle('com_codex.post-detail', 'com_codex/post-detail.css', ['version' => 'auto'])
    ->registerAndUseScript('com_codex.post-print', 'com_codex/post-print.js', ['version' => 'auto'], ['defer' => true]);
...
if ($showFeed) {
    $document->addHeadLink($feedUrl, 'alternate', 'rel', ['type' => 'application/rss+xml', 'title' => Text::_('COM_CODEX_CATEGORY_RSS')]);
}
?>
<div class="post-print-toolbar d-flex flex-wrap align-items-center gap-3 mb-3">
    ...
    <?php if ($showFeed) : ?>
        <a href="<?php echo htmlspecialchars($feedUrl, ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-link p-0"><span class="fa-solid fa-rss me-2" aria-hidden="true"></span><?php echo Text::_('COM_CODEX_CATEGORY_RSS'); ?></a>
    <?php endif; ?>
</div>
