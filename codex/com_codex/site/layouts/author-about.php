...
$profileUrl = Route::_('index.php?option=com_codex&view=author&id=' . $authorId);
...
$model = $app->bootComponent('com_codex')->getMVCFactory()->createModel('Posts', 'Site', ['ignore_request' => true]);
