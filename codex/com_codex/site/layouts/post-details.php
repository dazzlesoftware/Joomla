...
<div class="post-details text-muted small mb-3" aria-label="Post details">
    <div class="post-details-row d-flex flex-wrap align-items-baseline gap-2">
        ...
        <?php if ($params->get('show_author') && !empty($item->author)) : ?>
            <span>Written by: <a href="<?php echo Route::_('index.php?option=com_codex&view=author&id=' . (int) $item->created_by); ?>"><?php echo $escape($item->created_by_alias ?: $item->author); ?></a></span>
        <?php endif; ?>
        <span><?php echo \Joomla\Component\Codex\Site\Helper\DateHelper::render($item, $params); ?></span>
