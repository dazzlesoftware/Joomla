...
<form id="adminForm" action="<?php echo Route::_('index.php'); ?>" method="post" class="content-view-archive__form">
    <fieldset class="content-view-archive__filters filters">
        ...
        <div class="filter-search form-inline">
            ...
            <div class="mb-2">
                <label class="filter-search-lbl visually-hidden" for="filter-search"><?php echo Text::_('COM_CODEX_TITLE_FILTER_LABEL') . '&#160;'; ?></label>
                <input type="text" 
                    name="filter-search" 
                    id="filter-search" 
                    value="<?php echo $this->escape($this->filter); ?>" 
                    class="inputbox col-md-2" 
                    placeholder="<?php echo Text::_('COM_CODEX_TITLE_FILTER_LABEL'); ?>"
                >
            </div>
            <?php endif; ?>
