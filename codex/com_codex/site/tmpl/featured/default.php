...
\Joomla\CMS\Factory::getApplication()->getDocument()->getWebAssetManager()->registerAndUseStyle('com_codex.post-list-styles', 'com_codex/post-list-styles.css', ['version' => hash_file('sha256', JPATH_ROOT . '/media/com_codex/css/post-list-styles.css')]);
