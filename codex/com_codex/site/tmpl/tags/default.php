...
<article class="mb-4"><?php echo LayoutHelper::render('codex.content.featured_image', $item, JPATH_COMPONENT . '/layouts'); ?><h2><a href="<?php echo $url; ?>"><?php echo $escape($item->title); ?></a></h2>
