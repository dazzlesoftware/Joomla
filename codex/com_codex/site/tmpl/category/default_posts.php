        ...
        <table class="com-content-category__table category table table-striped table-bordered table-hover">
            ...
            <thead<?php echo $this->params->get('show_headings', '1') ? '' : ' class="visually-hidden"'; ?>>
                <tr>
                    ...
                    <?php if ($date = (\Joomla\Component\Codex\Site\Helper\DateHelper::options($this->params)[0] ? \Joomla\Component\Codex\Site\Helper\DateHelper::options($this->params)[1] : null)) : ?>
            ...
            <?php foreach ($this->items as $i => $post) : ?>
                ...
                <?php if (\Joomla\Component\Codex\Site\Helper\DateHelper::options($this->params)[0]) : ?>
                    <td class="list-date small">
                        <?php
                        echo HTMLHelper::_(
                            'date',
                            \Joomla\Component\Codex\Site\Helper\DateHelper::value($post, $this->params),
