            ...
            <div class="content-view-category__children">
                ...
                <h3 class="page-header item-title">
                    <?php if ($this->params->get('show_cat_num_posts', 1)) : ?>
                        <span class="badge bg-info tip hasTooltip" title="<?php echo HTMLHelper::_('tooltipText', 'COM_CODEX_NUM_ITEMS'); ?>">
                ...
                <?php if ($this->params->get('show_subcat_desc') == 1) : ?>
                    <?php if ($child->description) : ?>
                        <div class="category-desc">
                            <?php echo HTMLHelper::_('content.prepare', $child->description, '', 'com_codex.category'); ?>
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
