...
/** @var \Joomla\Component\Codex\Site\View\Categories\HtmlView $this */
                    ...
                    <div class="com-content-categories__item-title">
                        ...
                        <?php if ($this->params->get('show_cat_num_posts_cat') == 1) :?>
                            <span class="badge bg-info">
                                <?php echo Text::_('COM_CODEX_NUM_ITEMS'); ?>&nbsp;
                ...
                <?php if ($this->params->get('show_subcat_desc_cat') == 1) : ?>
                    <?php if ($item->description) : ?>
                        <div class="com-content-categories__description category-desc">
                            <?php echo HTMLHelper::_('content.prepare', $item->description, '', 'com_codex.categories'); ?>
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
