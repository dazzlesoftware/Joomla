...
<div class="content-view-categories">
    <?php if ($this->params->get('show_page_heading', 1)) : ?>
        <h1><?php echo $escape($this->params->get('page_heading') ?: Text::_('COM_CODEX_CATEGORIES_HEADING')); ?></h1>
    <?php endif; ?>
    ...
    <?php endif; ?>
        <?php foreach ($this->items as $item) : ?>
            <?php $url = Route::_('index.php?option=com_codex&view=category&id=' . (int) $item->id); ?>
            <?php if ($grid) : ?>
            <div class="col">
