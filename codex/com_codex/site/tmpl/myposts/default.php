...
$stateLabels = [
    ...
    2  => Text::_('JARCHIVED'),
    -3 => Text::_('COM_CODEX_POST_PENDING'),
];
?>
<?php echo LayoutHelper::render('postnav', ['params' => $this->params], JPATH_COMPONENT . '/layouts'); ?>
<div class="com-codex-myposts">
    <h1 class="mb-4"><?php echo $escape(Text::_('COM_CODEX_MY_POSTS_LABEL')); ?></h1>
    <table class="table">
        <thead>
            <tr>
        ...
        <tbody>
            <?php foreach ($this->items as $item) : ?>
                <tr>
                    ...
                    <td>
                        <a class="btn btn-sm btn-outline-primary" href="<?php echo Route::_('index.php?option=com_codex&task=post.edit&a_id=' . (int) $item->id); ?>">
            ...
            <?php endforeach; ?>
            <?php if (!$this->items) : ?>
                <tr><td colspan="4"><?php echo Text::_('COM_CODEX_MYPOSTS_EMPTY'); ?></td></tr>
            <?php endif; ?>
        </tbody>
    </table>
</div>
