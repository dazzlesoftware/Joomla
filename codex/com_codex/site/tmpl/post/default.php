...
$isWikiLayout = $isWikiLayout ?? false;
...
|| $params->get('show_hits') || $params->get('show_category') || $params->get('show_parent_category') || $params->get('show_author') || $assocParam; ?>
    ...
    <?php if ($useDefList && !$isWikiLayout) : ?>
...
<?php // Optional teaser excerpt for guests?>
    <?php elseif ($params->get('show_noauth') && $user->guest) : ?>
        <?php echo LayoutHelper::render('codex.content.featured_image', $this->item, JPATH_COMPONENT . '/layouts'); ?>
