...
namespace Joomla\Component\Codex\Site\View\Post;
...
use Joomla\Component\Codex\Site\Model\PostModel;
...
class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null)
    {
        ...
        $item->tags->getItemTags('com_codex.post', $this->item->id);
        ...
        PluginHelper::importPlugin('codex', null, true, $dispatcher);
    ...
    protected function _prepareDocument()
    {
        ...
        if (!$this->menuItemMatchPost) {
            ...
            if (
                $menu && $menu->component == 'com_codex' && isset($menu->query['view'])
            ...
            $category = Factory::getContainer()->get(\Joomla\Database\DatabaseInterface::class)->setQuery('SELECT id,title,language FROM #__codex_categories WHERE id=' . (int) $this->item->catid)->loadObject();
        ...
        \Joomla\Component\Codex\Site\Helper\SeoHelper::apply($this->getDocument(), $this->item);
