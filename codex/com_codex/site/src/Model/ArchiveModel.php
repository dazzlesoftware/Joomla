 ...
 * @since  1.5
 */
class ArchiveModel extends PostsModel
{
    /**
     ...
     * @var     string
     */
    public $_context = 'com_codex.archive';
    ...
    protected function populateState($ordering = null, $direction = null)
    {
        ...
        $this->setState('filter.published', CodexComponent::CONDITION_ARCHIVED);
        ...
        $limit  = $app->getUserStateFromRequest('com_codex.archive.list' . $itemid . '.limit', 'limit', $params->get('display_num', 20), 'uint');
    ...
    /**
     * Get the main query for retrieving a list of posts subject to the model state.
     *
    ...
    protected function getListQuery()
    {
        ...
        $queryDate = QueryHelper::getQueryDate($postOrderDate, $this->getDatabase());
    ...
    /**
     * Method to get the archived post list
     *
     * @access public
     * @return array
    ...
    public function getYears()
    {
        ...
        $query->select('DISTINCT ' . $years)
            ...
            ->where($db->quoteName('a.state') . ' = ' . CodexComponent::CONDITION_ARCHIVED)
            ->extendWhere(
                'AND',
                [
