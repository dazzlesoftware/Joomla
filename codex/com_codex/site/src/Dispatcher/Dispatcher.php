...
class Dispatcher extends ComponentDispatcher
{
    ...
    public function dispatch()
    {
        ...
        if ($this->app->isClient('site')
            ...
            && \Joomla\CMS\Component\ComponentHelper::getParams('com_codex')->get('show_powered_by', 1)
        ) {
            $this->app->getDocument()->getWebAssetManager()->registerAndUseStyle(
                'com_codex.post-list-styles',
                'com_codex/post-list-styles.css',
                ['version' => hash_file('sha256', JPATH_ROOT . '/media/com_codex/css/post-list-styles.css')]
            );
