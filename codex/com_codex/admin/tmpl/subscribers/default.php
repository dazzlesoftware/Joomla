...
<form action="<?php echo Route::_('index.php?option=com_codex&view=subscribers'); ?>" method="get" class="row g-2 mb-3">
    <input type="hidden" name="option" value="com_codex"><input type="hidden" name="view" value="subscribers">
