...
?>
<form action="<?php echo Route::_('index.php?option=com_codex'); ?>" method="post" id="vote-form">
    ...
    <a class="btn btn-outline-secondary" href="<?php echo Route::_('index.php?option=com_codex&view=votes'); ?>">Cancel</a>
