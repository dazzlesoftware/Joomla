...
/** @var \Joomla\Component\Codex\Administrator\View\Post\HtmlView $this */
...
$wa->registerAndUseStyle('com_codex.post-editor', 'com_codex/admin-post-editor.css', ['version' => '1.0.3']);
$wa->registerAndUseScript('com_codex.post-editor', 'com_codex/admin-post-editor.js', ['version' => '1.0.2'], ['type' => 'module']);
$wa->getRegistry()->addExtensionRegistryFile('com_contenthistory');
$wa->registerAndUseScript('com_codex.block-editor', 'com_codex/admin-block-editor.js', ['version' => '1.4.1'], ['type' => 'module'])
    ->registerAndUseStyle('com_codex.block-editor', 'com_codex/admin-block-editor.css', ['version' => '1.4.1']);
...
$tmpl    = $tmpl ? '&tmpl=' . $tmpl : '';
?>
<form action="<?php echo Route::_('index.php?option=com_codex&layout=' . $layout . $tmpl . '&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" aria-label="<?php echo Text::_('COM_CODEX_FORM_TITLE_' . ((int) $this->item->id === 0 ? 'NEW' : 'EDIT'), true); ?>" class="form-validate">
    <div class="post-editor-workspace">
        <div class="post-editor-heading">
            <span class="post-editor-eyebrow"><?php echo Text::_('COM_CODEX_EDITOR_WRITING'); ?></span>
            <div class="post-editor-actions">
                <a href="#post-advanced" class="btn btn-link" data-post-advanced-link><?php echo Text::_('COM_CODEX_EDITOR_ADVANCED'); ?></a>
                <button type="button" class="btn btn-outline-secondary" data-post-focus aria-pressed="false" aria-controls="post-settings" hidden><?php echo Text::_('COM_CODEX_EDITOR_FOCUS'); ?></button>
            </div>
        </div>
        <div class="post-editor-grid">
            <div class="post-editor-writing" data-post-editor-column>
                <div class="post-editor-title form-vertical">
                    <?php $this->form->setFieldAttribute('title', 'hint', 'COM_CODEX_EDITOR_TITLE_HINT'); ?>
                    <?php echo $this->form->renderField('title'); ?>
                </div>
                <div>
                    <fieldset class="adminform">
                        <?php $pollDb = Factory::getContainer()->get(DatabaseInterface::class); $pollItems = $pollDb->setQuery($pollDb->createQuery()->select(['id','title'])->from('#__codex_polls')->where('state=1')->order('title'))->loadObjectList(); ?>
                        <details class="post-editor-excerpt" <?php echo trim((string) $this->form->getValue('excerpt')) !== '' ? 'open' : ''; ?>>
                            <summary><?php echo Text::_('COM_CODEX_FIELD_EXCERPT_LABEL'); ?><span><?php echo Text::_('COM_CODEX_EDITOR_OPTIONAL'); ?></span></summary>
                            <div class="post-editor-panel-body form-vertical">
                                <?php echo $this->form->renderField('excerpt'); ?>
                                <p class="post-editor-hint"><?php echo Text::_('COM_CODEX_FIELD_EXCERPT_DESC'); ?></p>
                            </div>
                        </details>
                        <div data-post-block-editor data-editor-id="jform_post_content" data-default-mode="<?php echo htmlspecialchars(ComponentHelper::getParams('com_codex')->get('default_editor_mode', 'classic'), ENT_QUOTES, 'UTF-8'); ?>" data-polls="<?php echo htmlspecialchars(json_encode($pollItems), ENT_QUOTES, 'UTF-8'); ?>">
            ...
            <aside class="post-editor-settings" id="post-settings" aria-label="<?php echo Text::_('COM_CODEX_EDITOR_SETTINGS'); ?>" data-post-global-column>
                <h2><?php echo Text::_('COM_CODEX_EDITOR_SETTINGS'); ?></h2>
                <details class="post-editor-panel">
                    <summary><?php echo Text::_('COM_CODEX_EDITOR_VISIBILITY'); ?></summary>
                    <div class="post-editor-panel-body form-vertical">
                    ...
                    <details class="post-editor-panel" open>
                        ...
                        <div id="fieldset-image-featured" class="post-editor-panel-body form-vertical">
                            ...
                            <details class="post-editor-image-options">
                                <summary><?php echo Text::_('COM_CODEX_EDITOR_IMAGE_DETAILS'); ?></summary>
        ...
        <?php if ($params->get('show_publishing_options', 1) == 1) : ?>
            <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'publishing', Text::_('COM_CODEX_FIELDSET_PUBLISHING')); ?>
            <div class="row">
        ...
        <?php if ($this->canDo->get('core.admin') && $params->get('show_configure_edit_options', 1) == 1) : ?>
            <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'editor', Text::_('COM_CODEX_SLIDER_EDITOR_CONFIG')); ?>
            <fieldset id="fieldset-editor" class="options-form">
                <legend><?php echo Text::_('COM_CODEX_SLIDER_EDITOR_CONFIG'); ?></legend>
                <div class="form-grid">
        ...
        <?php if ($this->canDo->get('core.admin') && $params->get('show_permissions', 1) == 1) : ?>
            <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'permissions', Text::_('COM_CODEX_FIELDSET_RULES')); ?>
            <fieldset id="fieldset-rules" class="options-form">
                <legend><?php echo Text::_('COM_CODEX_FIELDSET_RULES'); ?></legend>
                <div>
