...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a class="btn btn-success" href="<?php echo Route::_('index.php?option=com_codex&task=post.add'); ?>">New Post</a>
    </div>

    <div class="row g-3 mb-4">
        <?php foreach ($cards as $key => $card) : ?>
            <div class="col-sm-6 col-xl-2">
                <a class="card text-decoration-none h-100" href="<?php echo Route::_('index.php?' . (str_starts_with($card[1], 'option=') ? $card[1] : 'option=com_codex&' . $card[1])); ?>">
                    <div class="card-body">
            ...
            <table class="table mb-0">
                ...
                <tbody>
                    <?php foreach ($this->recent as $post) : ?>
                        <tr>
                            <td><a href="<?php echo Route::_('index.php?option=com_codex&task=post.edit&id=' . (int) $post->id); ?>"><?php echo $escape($post->title); ?></a></td>
