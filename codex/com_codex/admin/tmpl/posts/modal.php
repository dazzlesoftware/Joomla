...
$wa->useScript('core')
    ...
    ->useScript('com_codex.admin-posts-modal');
...
<div class="container-popup">
    ...
    <form action="<?php echo Route::_('index.php?option=com_codex&view=posts&layout=modal&tmpl=component&function=' . $function . '&' . Session::getFormToken() . '=1&editor=' . $editor); ?>" method="post" name="adminForm" id="adminForm">

        <?php echo LayoutHelper::render('codex.searchtools.default', ['view' => $this]); ?>
...
?>
    ...
    $lang = '';
                    ...
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <th scope="row">
                            <?php $attribs = 'data-content-select data-content-type="com_codex.post"'
