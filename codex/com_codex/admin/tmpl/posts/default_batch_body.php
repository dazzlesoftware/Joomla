    ...
    <div class="row">
        <?php if (Multilanguage::isEnabled()) : ?>
            <div class="form-group col-md-6">
                <div class="controls">
                    <?php echo LayoutHelper::render('codex.html.batch.language', []); ?>
                </div>
            </div>
        <?php endif; ?>
        <div class="form-group col-md-6">
            <div class="controls">
                <?php echo LayoutHelper::render('codex.html.batch.access', []); ?>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="form-group col-md-6">
            <div class="controls">
                <?php echo LayoutHelper::render('codex.html.batch.item', ['extension' => 'com_codex']); ?>
            </div>
        </div>
        <?php endif; ?>
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
            <div class="controls">
                <?php echo LayoutHelper::render('codex.html.batch.workflowstage', ['extension' => 'com_codex']); ?>
            </div>
        </div>
        <?php endif; ?>
    </div>
