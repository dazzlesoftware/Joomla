...
/** @var \Joomla\Component\Codex\Administrator\View\Category\HtmlView $this */
?>
<form
    action="<?php echo Route::_('index.php?option=com_codex&view=category&id=' . (int) $this->item->id); ?>"
    method="post"
    name="adminForm"
    id="adminForm"
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label" for="jform_parent_id"><?php echo Text::_('COM_CODEX_PARENT_CATEGORY_LABEL'); ?></label>
                            <select class="form-select" id="jform_parent_id" name="jform[parent_id]">
                                <option value="0"><?php echo Text::_('COM_CODEX_PARENT_CATEGORY_ROOT'); ?></option>
                    ...
                    <div class="mb-3">
                        <label class="form-label" for="jform_default_tags"><?php echo Text::_('COM_CODEX_DEFAULT_TAGS_LABEL'); ?></label>
                        <input
                            class="form-control"
                            id="jform_default_tags"
                            name="jform[default_tags]"
                            value="<?php echo htmlspecialchars($this->item->default_tags, ENT_QUOTES, 'UTF-8'); ?>"
                            placeholder="<?php echo Text::_('COM_CODEX_DEFAULT_TAGS_PLACEHOLDER'); ?>"
                        >
                        <div class="form-text"><?php echo Text::_('COM_CODEX_DEFAULT_TAGS_DESC'); ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="mb-3 form-check form-switch">
                        ...
                        >
                        <label class="form-check-label" for="jform_allow_autoposting"><?php echo Text::_('COM_CODEX_ALLOW_AUTOPOSTING_LABEL'); ?></label>
                        <div class="form-text"><?php echo Text::_('COM_CODEX_ALLOW_AUTOPOSTING_DESC'); ?></div>
                    </div>
                    <div class="mb-0 form-check form-switch">
                        ...
                        >
                        <label class="form-check-label" for="jform_is_default"><?php echo Text::_('COM_CODEX_FIELD_CATEGORY_DEFAULT_LABEL'); ?></label>
                        <div class="form-text"><?php echo Text::_('COM_CODEX_FIELD_CATEGORY_DEFAULT_DESC'); ?></div>
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                    <label class="form-label" for="jform_default_image"><?php echo Text::_('COM_CODEX_DEFAULT_POST_COVER_LABEL'); ?></label>
                    <?php if ($this->item->default_image !== '') : ?>
                        ...
                        <div class="form-check mb-2">
                            ...
                            <label class="form-check-label" for="jform_remove_image"><?php echo Text::_('COM_CODEX_DEFAULT_POST_COVER_REMOVE'); ?></label>
                        </div>
                    <?php endif; ?>
                    <input type="file" class="form-control" id="jform_default_image" name="jform_default_image" accept="image/*">
                    <div class="form-text"><?php echo Text::_('COM_CODEX_DEFAULT_POST_COVER_DESC'); ?></div>
            ...
            <?php if ($this->associationLanguages) : ?>
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <p class="form-text"><?php echo Text::_('COM_CODEX_ASSOCIATIONS_DESC'); ?></p>
