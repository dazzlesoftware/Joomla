...
?>
<form action="<?php echo Route::_('index.php?option=com_codex&view=settings'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row g-4 com-codex-settings">
            ...
            <div class="tab-content">
                <?php foreach ($this->sections as $key => $section) : ?>
                    <section class="tab-pane fade<?php echo $key === $active ? ' show active' : ''; ?>" id="settings-<?php echo $key; ?>" role="tabpanel">
                        <div class="mb-3"><h2><?php echo $section['label']; ?></h2><p class="text-muted">Configure <?php echo strtolower($section['label']); ?> for Codex Posts.</p></div>
                        <div class="row g-4">
