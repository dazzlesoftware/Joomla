...
/** @var \Joomla\Component\Codex\Administrator\View\Tag\HtmlView $this */

$item = $this->item;
$escape = static fn ($value) => htmlspecialchars((string) $value, ENT_QUOTES, 'UTF-8');
?>
<form action="<?php echo Route::_('index.php?option=com_codex&task=tag.save'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="alert alert-light border mb-3">
        <h1 class="h4 mb-1"><?php echo Text::_($item->id ? 'COM_CODEX_EDIT_TAG' : 'COM_CODEX_ADD_TAG'); ?></h1>
        <p class="mb-0 small text-muted"><?php echo Text::_('COM_CODEX_TAG_EDIT_DESC'); ?></p>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                <label class="form-label" for="jform_title"><?php echo Text::_('COM_CODEX_FIELD_TAG_TITLE_LABEL'); ?></label>
                <input required maxlength="255" class="form-control" id="jform_title" name="jform[title]" value="<?php echo $escape($item->title); ?>">
            </div>

            <div class="mb-3">
                <label class="form-label" for="jform_alias"><?php echo Text::_('COM_CODEX_FIELD_TAG_ALIAS_LABEL'); ?></label>
                <input class="form-control" id="jform_alias" name="jform[alias]" maxlength="191" value="<?php echo $escape($item->alias); ?>" placeholder="<?php echo Text::_('COM_CODEX_FIELD_TAG_ALIAS_PLACEHOLDER'); ?>">
            </div>

            <div class="mb-3">
                <label class="form-label" for="jform_description"><?php echo Text::_('COM_CODEX_FIELD_TAG_DESCRIPTION_LABEL'); ?></label>
            ...
            <div class="mb-0 form-check form-switch">
                ...
                >
                <label class="form-check-label" for="jform_is_default"><?php echo Text::_('COM_CODEX_FIELD_TAG_DEFAULT_LABEL'); ?></label>
                <div class="form-text"><?php echo Text::_('COM_CODEX_FIELD_TAG_DEFAULT_DESC'); ?></div>
            </div>
        </div>
    </div>
