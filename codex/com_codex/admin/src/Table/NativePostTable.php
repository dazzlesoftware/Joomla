...
class NativePostTable extends Table implements CurrentUserInterface
{
    ...
    public function __construct(DatabaseInterface $db, ?DispatcherInterface $dispatcher = null)
    {
        ...
        parent::__construct('#__codex', 'id', $db, $dispatcher);
    ...
    protected function _getAssetName()
    {
        ...
        return 'com_codex.post.' . (int) $this->$k;
    }
    ...
    public function check()
    {
        ...
        if (trim($this->title) == '') {
            $this->setError(Text::_('COM_CODEX_WARNING_PROVIDE_VALID_NAME'));
    ...
    public function store($updateNulls = true)
    {
        ...
        if ($table->load(['alias' => $this->alias, 'catid' => $this->catid]) && ($table->id != $this->id || $this->id == 0)) {
            ...
            $this->setError(Text::_('COM_CODEX_ERROR_UNIQUE_ALIAS'));

            if ($table->state === -2) {
                $this->setError(Text::_('COM_CODEX_ERROR_UNIQUE_ALIAS_TRASHED'));
            }
