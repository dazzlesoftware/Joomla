...
final class SettingsController extends BaseController
{
    ...
    {
        $this->setRedirect(Route::_('index.php?option=com_codex&view=dashboard', false));
    }
    ...
    private function saveSettings(bool $close): void
    {
        ...
        $app->enqueueMessage(Text::_('COM_CODEX_SETTINGS_SAVED'));
        $view = $close ? 'dashboard' : 'settings';
        $this->setRedirect(Route::_('index.php?option=com_codex&view=' . $view, false));
    }
}
