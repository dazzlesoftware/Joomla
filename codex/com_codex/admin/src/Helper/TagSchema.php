...
final class TagSchema
{
    ...
    {
        $db->setQuery("CREATE TABLE IF NOT EXISTS #__codex_tags (id INT UNSIGNED NOT NULL AUTO_INCREMENT, title VARCHAR(255) NOT NULL, alias VARCHAR(191) NOT NULL, description TEXT NOT NULL, published TINYINT NOT NULL DEFAULT 1, access INT UNSIGNED NOT NULL DEFAULT 1, language VARCHAR(7) NOT NULL DEFAULT '*', params TEXT NOT NULL, PRIMARY KEY(id), UNIQUE KEY idx_alias(alias), KEY idx_state(published)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci")->execute();
