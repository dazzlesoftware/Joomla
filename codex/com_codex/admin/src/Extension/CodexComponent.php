...
namespace Joomla\Component\Codex\Administrator\Extension;
...
use Joomla\Component\Codex\Administrator\Service\HTML\AdministratorService;
use Joomla\Component\Codex\Administrator\Service\HTML\Icon;
...
/**
 * Component class for com_codex
 *
 * @since  4.0.0
 */
class CodexComponent extends MVCComponent implements
    ...
    TagServiceInterface
{
    ...
    {
        Factory::getLanguage()->load('com_codex', JPATH_SITE);
        ...
        // our own codex.content.icons layout override
        // (site/layouts/codex/content/icons.php, overriding core's
        // joomla.content.icons) that calls this 'codexicon' service
    ...
    {
        Factory::getLanguage()->load('com_codex', JPATH_ADMINISTRATOR);

        $contexts = [
            'com_codex.post'    => Text::_('COM_CODEX'),
            'com_codex.categories' => Text::_('JCATEGORY'),
        ];
