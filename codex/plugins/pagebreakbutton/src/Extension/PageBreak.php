...
namespace Joomla\Plugin\Codex\Pagebreakbutton\Extension;
...
final class PageBreak extends CMSPlugin implements SubscriberInterface
{
    ...
    public function onDisplay($name)
    {
        ...
        $canCreateRecords = $user->authorise('core.create', 'com_codex')
            || \count($user->getAuthorisedCategories('com_codex', 'core.create')) > 0;

        // Instead of checking edit on all records, we can use **same** check as the form editing view
        $values           = (array) $app->getUserState('com_codex.edit.post.id');
        ...
        $link = 'index.php?option=com_codex&view=post&layout=pagebreak&tmpl=component&e_name=' . $name;
