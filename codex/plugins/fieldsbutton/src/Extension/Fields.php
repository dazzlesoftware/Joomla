...
namespace Joomla\Plugin\Codex\Fieldsbutton\Extension;
...
final class Fields extends CMSPlugin implements SubscriberInterface
{
    ...
    public function onDisplay($name)
    {
        ...
        // Special context for com_codex
        if ($context === 'com_codex.category') {
            $context = $jinput->get('extension', 'com_codex') . '.categories';
        }
        ...
        $button = new Button(
            ...
            [
                'action'  => 'modal',
                'link'    => $link,
                'text'    => Text::_('PLG_CODEX_FIELDSBUTTON_BUTTON_FIELD'),
                'icon'    => 'puzzle',
