...
namespace Joomla\Plugin\Codex\Postbutton\Extension;
...
final class Post extends CMSPlugin implements SubscriberInterface
{
    ...
    public function onDisplay($name)
    {
        ...
        $values           = (array) $this->getApplication()->getUserState('com_codex.edit.post.id');
        ...
        $link = 'index.php?option=com_codex&view=posts&layout=modal&tmpl=component&'
