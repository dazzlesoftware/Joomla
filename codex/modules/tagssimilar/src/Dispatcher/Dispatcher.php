...
namespace Joomla\Module\CodexTagssimilar\Site\Dispatcher;
...
final class Dispatcher extends AbstractModuleDispatcher
{
    protected function getLayoutData(): array
    {
        ...
        Factory::getApplication()->bootComponent('com_codex');
        $dateParams = clone \Joomla\CMS\Component\ComponentHelper::getParams('com_codex');
