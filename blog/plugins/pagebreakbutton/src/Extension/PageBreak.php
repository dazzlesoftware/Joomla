...
namespace Joomla\Plugin\Blog\Pagebreakbutton\Extension;
...
final class PageBreak extends CMSPlugin implements SubscriberInterface
{
    ...
    public function onDisplay($name)
    {
        ...
        $values           = (array) $app->getUserState('com_blog.edit.post.id');
        ...
        $link = 'index.php?option=com_blog&view=post&layout=pagebreak&tmpl=component&e_name=' . $name;
