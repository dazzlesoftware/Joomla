...
$wa->registerAndUseStyle('plg_blog_vote', 'plg_blog_vote/rating.css');
...
if ($context === 'com_blog.categories') {
    return;
}

// Get the icons
$iconStar     = HTMLHelper::_('image', 'plg_blog_vote/vote-star.svg', '', '', true, true);
$iconHalfstar = HTMLHelper::_('image', 'plg_blog_vote/vote-star-half.svg', '', '', true, true);
