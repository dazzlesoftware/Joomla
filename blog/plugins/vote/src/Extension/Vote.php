...
namespace Joomla\Plugin\Blog\Vote\Extension;
...
final class Vote extends CMSPlugin implements SubscriberInterface
{
     ...
     * Add HTML string containing code for the votes if in com_blog.
     *
     ...
     *
     * @return  string  HTML string containing code for the votes if in com_blog else empty string
     *
     * @since   3.7.0
     */
    private function displayVotingData($context, $row, $params, $page)
    {
        ...
        $path = PluginHelper::getLayoutPath('blog', 'vote', 'rating');
        ...
        if ($this->getApplication()->getInput()->getString('view', '') === 'post' && $row->state == 1) {
            ...
            $path = PluginHelper::getLayoutPath('blog', 'vote', 'vote');
