...
namespace Joomla\Plugin\Blog\Fieldsbutton\Extension;
...
final class Fields extends CMSPlugin implements SubscriberInterface
{
    ...
    public function onDisplay($name)
    {
        ...
        // Special context for com_blog
        if ($context === 'com_blog.category') {
            $context = $jinput->get('extension', 'com_blog') . '.categories';
        }
        ...
        $button = new Button(
            ...
            [
                'action'  => 'modal',
                'link'    => $link,
                'text'    => Text::_('PLG_BLOG_FIELDSBUTTON_BUTTON_FIELD'),
                'icon'    => 'puzzle',
