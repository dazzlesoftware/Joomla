...
namespace Joomla\Plugin\Blog\Confirmconsent\Field;
...
class ConsentBoxField extends CheckboxesField
{
    ...
    private function getAssignedPostUrl()
    {
        ...
        try {
            ...
            return Route::_(
                'index.php?option=com_blog&view=post&id='
        ...
        $associatedPosts = Associations::getAssociations('com_blog', '#__blog', 'com_blog.item', $post->id);
