...
class Com_BlogInstallerScript
{
    public function postflight(string $type, InstallerAdapter $adapter): bool
    {
        ...
        foreach ([
            JPATH_ADMINISTRATOR . '/components/com_blog/src/Helper/AiService.php',
            JPATH_ADMINISTRATOR . '/components/com_blog/src/Helper/AiUiHelper.php',
            JPATH_ADMINISTRATOR . '/components/com_blog/src/Controller/AiController.php',
            JPATH_ROOT . '/components/com_blog/src/Controller/AiController.php',
            JPATH_ROOT . '/media/com_blog/js/ai-editor.js',
        ] as $obsolete) {
