...
namespace Joomla\Component\Blog\Site\View\Form;
...
use Joomla\Component\Blog\Site\Model\FormModel;
...
class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null)
    {
        ...
        if (empty($this->item->id)) {
            $authorised = (bool) $authorised && \Joomla\Component\Blog\Site\Helper\SubmissionHelper::hasAccess($user);
        }
        ...
        if (!empty($this->item->id)) {
            $this->item->tags->getItemTags('com_blog.post', $this->item->id);
        ...
        if (
            $this->item->id
            && \Joomla\Component\Blog\Site\Helper\SubmissionHelper::hasAccess($user)
            && ($user->authorise('core.create', 'com_blog') || \count($user->getAuthorisedCategories('com_blog', 'core.create')))
        ) {
    ...
    protected function _prepareDocument()
    {
        ...
        if ($menu) {
            ...
            $this->params->def('page_heading', Text::_('COM_BLOG_FORM_EDIT_POST'));
        }

        $title = $this->params->def('page_title', Text::_('COM_BLOG_FORM_EDIT_POST'));
