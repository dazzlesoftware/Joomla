...
final class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null): void
    {
        ...
        foreach ($this->posts as $post) {
            ...
            $post->text = \Joomla\Component\Blog\Site\Helper\ListExcerptHelper::render($post, $this->params);
            $app->triggerEvent('onContentPrepare', ['com_blog.author', &$post, &$this->params, 0]);
