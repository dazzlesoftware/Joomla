...
namespace Joomla\Component\Blog\Site\View\MyPosts;
...
final class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null): void
    {
        ...
        if ($user->guest) {
            $return = base64_encode(Route::_('index.php?option=com_blog&view=myposts', false));
            $app->enqueueMessage(Text::_('COM_BLOG_MYPOSTS_LOGIN_REQUIRED'), 'warning');
        ...
        $this->getDocument()->setTitle(Text::_('COM_BLOG_MY_POSTS_LABEL'));
        parent::display($tpl);
    }
}
