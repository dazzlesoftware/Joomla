...
class FeaturedModel extends PostsModel
{
    ...
    protected function populateState($ordering = null, $direction = null)
    {
        ...
        $limit = $params->get('num_leading_posts') + $params->get('num_intro_posts') + (\Joomla\Component\Blog\Site\Helper\CompactPostsHelper::visible($params) && $params->get('compact_selection', 'next') === 'next' ? $params->get('num_links') : 0);
        ...
        if ((!$user->authorise('core.edit.state', 'com_blog')) && (!$user->authorise('core.edit', 'com_blog'))) {
            ...
            $this->setState('filter.published', [BlogComponent::CONDITION_UNPUBLISHED, BlogComponent::CONDITION_PUBLISHED]);
        }
