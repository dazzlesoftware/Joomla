 ...
 * @since  1.5
 */
class FormModel extends \Joomla\Component\Blog\Administrator\Model\PostModel
{
    /**
    ...
    public function getItem($itemId = null)
    {
        ...
        if ($itemId) {
            ...
            $value->tags->getTagIds($value->id, 'com_blog.post');
    ...
    public function getForm($data = [], $loadData = true)
    {
        ...
        if ($id > 0 && !$user->authorise('core.edit.state', 'com_blog.post.' . $id)) {
