...
class ArchiveModel extends PostsModel
{
     ...
     * @var     string
     */
    public $_context = 'com_blog.archive';
    ...
    protected function populateState($ordering = null, $direction = null)
    {
        ...
        $this->setState('filter.published', BlogComponent::CONDITION_ARCHIVED);
        ...
        $limit  = $app->getUserStateFromRequest('com_blog.archive.list' . $itemid . '.limit', 'limit', $params->get('display_num', 20), 'uint');
    ...
    public function getYears()
    {
        ...
        $query->select('DISTINCT ' . $years)
            ...
            ->where($db->quoteName('a.state') . ' = ' . BlogComponent::CONDITION_ARCHIVED)
            ->extendWhere(
                'AND',
                [
