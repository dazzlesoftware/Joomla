...
/** @var \Joomla\Component\Blog\Site\View\Post\HtmlView $this */
...
|| $params->get('show_hits') || $params->get('show_category') || $params->get('show_parent_category') || $params->get('show_author') || $assocParam; ?>
    ...
    <div class="post-print-toolbar d-flex flex-wrap align-items-baseline gap-3 mb-3">
        ...
        <?php if (!$isWikiLayout && ($dateHtml = \Joomla\Component\Blog\Site\Helper\DateHelper::render($this->item, $params))) : ?>
...
<?php // Optional teaser excerpt for guests?>
    <?php elseif ($params->get('show_noauth') && $user->guest) : ?>
        <?php echo LayoutHelper::render('blog.content.featured_image', $this->item, JPATH_COMPONENT . '/layouts'); ?>
