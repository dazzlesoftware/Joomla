...
$app->getDocument()->getWebAssetManager()->registerAndUseStyle('com_blog.post-list-styles', 'com_blog/post-list-styles.css', ['version' => 'auto']);
...
<div class="com-blog-category-blog blog">
    ...
    <?php if (!empty($this->lead_items)) : ?>
        <div class="com-blog-category-blog__items post-list-items items-leading row row-cols-1 g-4 mb-4 post-style-<?php echo $listStyle; ?>">
            <?php foreach ($this->lead_items as &$item) : ?>
                <div class="com-blog-category-blog__item post-list-item col">
                    <?php
                    $this->item = &$item;
    ...
    <?php if (!empty($this->intro_items)) : ?>
        ...
        <?php endif; ?>
        <div class="com-blog-category-blog__items post-list-items post-style-<?php echo $listStyle; ?><?php echo $blogClass; ?>">
    ...
    <?php if (($this->params->def('show_pagination', 1) == 1 || $this->params->get('show_pagination') == 2) && $this->pagination->pagesTotal > 1) : ?>
        <div class="com-blog-category-blog__navigation w-100">
            ...
            <?php endif; ?>
            <div class="com-blog-category-blog__pagination">
