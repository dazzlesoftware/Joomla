...
<div class="com-blog-category-blog blog">
    ...
    <?php if (!empty($this->lead_items)) : ?>
        <div class="com-blog-category-blog__items blog-items items-leading post-style-<?php echo $listStyle; ?>">
            <?php foreach ($this->lead_items as &$item) : ?>
                <div class="com-blog-category-blog__item blog-item">
                    <?php
                    $this->item = &$item;
    ...
    <?php if (!empty($this->intro_items)) : ?>
        ...
        <?php endif; ?>
        <div class="com-blog-category-blog__items blog-items post-style-<?php echo $listStyle; ?><?php echo $blogClass; ?>">
