...
$wa->useScript('com_blog.posts-list');
        ...
        <div class="com-content__filter btn-group">
            ...
            <?php else : ?>
                ...
                <input type="text" 
                    ...
                    class="inputbox" 
                    placeholder="<?php echo Text::_('COM_BLOG_' . $this->params->get('filter_field') . '_FILTER_LABEL'); ?>"
                >
            <?php endif; ?>
    ...
    <?php else : ?>
        <table class="com-content-category__table category table table-striped table-bordered table-hover">
            <caption class="visually-hidden">
                <?php echo Text::_('COM_BLOG_POSTS_TABLE_CAPTION'); ?>
            </caption>
            <thead<?php echo $this->params->get('show_headings', '1') ? '' : ' class="visually-hidden"'; ?>>
                <tr>
                    ...
                    <?php if ($date = (\Joomla\Component\Blog\Site\Helper\DateHelper::options($this->params)[0] ? \Joomla\Component\Blog\Site\Helper\DateHelper::options($this->params)[1] : null)) : ?>
            ...
            <?php foreach ($this->items as $i => $post) : ?>
                <?php if ($this->items[$i]->state == BlogComponent::CONDITION_UNPUBLISHED) : ?>
                ...
                <th class="list-title" scope="row">
                    ...
                    <?php else : ?>
                        ...
                        <?php endif; ?>
                    <?php endif; ?>
                    <?php if ($post->state == BlogComponent::CONDITION_UNPUBLISHED) : ?>
                        <div>
                ...
                <?php if (\Joomla\Component\Blog\Site\Helper\DateHelper::options($this->params)[0]) : ?>
                    <td class="list-date small">
                        <?php
                        echo HTMLHelper::_(
                            'date',
                            \Joomla\Component\Blog\Site\Helper\DateHelper::value($post, $this->params),
                    ...
                    <td class="list-author">
                        <?php if (!empty($post->author) || !empty($post->created_by_alias)) : ?>
                            ...
                            <?php if (!empty($post->contact_link) && $this->params->get('link_author')) : ?>
                                ...
                                <?php else : ?>
                                    <?php echo Text::sprintf('COM_BLOG_WRITTEN_BY', HTMLHelper::_('link', $post->contact_link, $author)); ?>
                                <?php endif; ?>
                            <?php else : ?>
                                <?php if ($this->params->get('show_headings')) : ?>
                                    <?php echo $author; ?>
                ...
                <?php if ($this->params->get('list_show_votes', 0) && $this->vote) : ?>
                    <td class="list-votes">
                        <span class="badge bg-success">
                            ...
                            <?php else : ?>
                                <?php echo Text::sprintf('COM_BLOG_VOTES_COUNT', $post->rating_count); ?>
                            <?php endif; ?>
                        </span>
                    </td>
                <?php endif; ?>
                <?php if ($this->params->get('list_show_ratings', 0) && $this->vote) : ?>
                    <td class="list-ratings">
                        <span class="badge bg-warning text-light">
                            ...
                            <?php else : ?>
                                <?php echo Text::sprintf('COM_BLOG_RATINGS_COUNT', $post->rating); ?>
                            <?php endif; ?>
                        </span>
                    </td>
                <?php endif; ?>
                <?php if ($isEditable) : ?>
                    <td class="list-edit">
                        <?php if ($post->params->get('access-edit')) : ?>
                            <?php echo HTMLHelper::_('blogicon.edit', $post, $post->params); ?>
                        <?php endif; ?>
                    </td>
                <?php endif; ?>
                </tr>
