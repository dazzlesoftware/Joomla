...
<?php $item->summary = HTMLHelper::_('content.prepare', $item->summary, '', 'com_blog.post'); echo ListExcerptHelper::render($item, $item->params); ?>
...
<?php else : ?>
<ul class="list-unstyled d-flex flex-wrap gap-2"><?php foreach ($this->tags as $tag) : ?><li><a class="btn btn-outline-primary" href="<?php echo Route::_('index.php?option=com_blog&view=tags&tag_id=' . (int) $tag->id); ?>"><?php echo $escape($tag->title); ?></a></li><?php endforeach; ?></ul>
