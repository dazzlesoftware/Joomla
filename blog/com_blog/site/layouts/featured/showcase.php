...
use Joomla\Component\Blog\Site\Helper\DateHelper;
$style = $displayData['style'];
$items = $displayData['items'];
$params = $displayData['params'];
$id = 'blog-featured-' . bin2hex(random_bytes(6));
...
<?php if ($show('author')) : ?><div><span class="fa-solid fa-user me-1" aria-hidden="true"></span><a href="<?php echo $escape(Route::_('index.php?option=com_blog&view=author&id=' . (int) $item->created_by)); ?>"><?php echo $escape($item->created_by_alias ?: $item->author); ?></a></div><?php endif; ?>
...
</div><?php if ($show('avatar')) : ?><div class="ms-auto"><?php echo LayoutHelper::render('post.avatar', $item, JPATH_ROOT . '/components/com_blog/layouts'); ?></div><?php endif; ?></footer><?php endif; ?>
...
$wa->registerAndUseStyle('com_blog.featured-styles', 'com_blog/featured-styles.css', ['version' => 'auto']);
$wa->registerAndUseScript('com_blog.featured-slider', 'com_blog/featured-slider.js', ['version' => 'auto'], ['defer' => true], ['bootstrap.carousel']);
