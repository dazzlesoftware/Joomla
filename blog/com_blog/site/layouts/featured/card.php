...
<?php
\Joomla\CMS\Factory::getApplication()->getDocument()->getWebAssetManager()->registerAndUseScript('com_blog.featured-slider', 'com_blog/featured-slider.js', ['version' => 'auto'], ['defer' => true], ['bootstrap.carousel']);
