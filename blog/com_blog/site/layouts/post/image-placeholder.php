...
?>
<?php if ($linked) : ?>
<a href="<?php echo htmlspecialchars(\Joomla\CMS\Router\Route::_(\Joomla\Component\Blog\Site\Helper\RouteHelper::getPostRoute($item->slug, $item->catid, $item->language)), ENT_QUOTES, 'UTF-8'); ?>" class="d-block">
<?php endif; ?>
