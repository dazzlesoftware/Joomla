...
<div class="d-flex gap-2 mb-3">
    <form action="<?php echo Route::_('index.php?option=com_blog&task=newsletter.state'); ?>" method="post">
        <input type="hidden" name="campaign_id" value="<?php echo (int) $this->item->id; ?>">
...
<p><a class="btn btn-outline-primary" href="<?php echo Route::_('index.php?option=com_blog&task=newsletter.export&campaign_id=' . (int) $this->item->id); ?>">Export recipient report (CSV)</a></p>
