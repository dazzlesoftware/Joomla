...
$wa->useScript('com_blog.admin-post-pagebreak');

$this->eName = Factory::getApplication()->getInput()->getCmd('e_name', '');
$this->eName = preg_replace('#[^A-Z0-9\-\_\[\]]#i', '', $this->eName);
$this->getDocument()->setTitle(Text::_('COM_BLOG_PAGEBREAK_DOC_TITLE'));
    ...
    <form>
        <div class="control-group">
            <div class="control-label">
                <label for="title"><?php echo Text::_('COM_BLOG_PAGEBREAK_TITLE'); ?></label>
            </div>
            <div class="controls">
        ...
        <div class="control-group">
            <div class="control-label">
                <label for="alias"><?php echo Text::_('COM_BLOG_PAGEBREAK_TOC'); ?></label>
            </div>
            <div class="controls">
        ...
        <button onclick="insertPagebreak('<?php echo $this->eName; ?>');" class="btn btn-success">
            <?php echo Text::_('COM_BLOG_PAGEBREAK_INSERT_BUTTON'); ?>
        </button>
