...
?>
<form action="<?php echo Route::_('index.php?option=com_blog&view=categories'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="alert alert-light border mb-3">
        <h1 class="h4 mb-1"><?php echo Text::_('COM_BLOG_CATEGORIES_TITLE'); ?></h1>
        <p class="mb-0 small text-muted"><?php echo Text::_('COM_BLOG_CATEGORIES_DESC'); ?></p>
    </div>
    ...
    <?php else : ?>
        <div class="table-responsive">
            <table class="table table-hover" id="categoryList">
                <caption class="visually-hidden"><?php echo Text::_('COM_BLOG_CATEGORIES_TABLE_CAPTION'); ?></caption>
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="w-10 text-center d-none d-md-table-cell">
                            <?php echo HTMLHelper::_('searchtools.sort', 'COM_BLOG_HEADING_SUBCATEGORIES', 'sub_count', $this->listDirn, $this->listOrder); ?>
                        </th>
                ...
                <?php foreach ($this->items as $i => $item) : ?>
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <th scope="row">
                            <a href="<?php echo Route::_('index.php?option=com_blog&view=category&id=' . (int) $item->id); ?>">
