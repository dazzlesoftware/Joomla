...
namespace Joomla\Component\Blog\Administrator\Field\Modal;
...
class PostField extends ModalSelectField
{
    ...
    public function setup(\SimpleXMLElement $element, $value, $group = null)
    {
        ...
        Factory::getApplication()->getLanguage()->load('com_blog', JPATH_ADMINISTRATOR);
        ...
        if ($language) {
            ...
            $modalTitle = Text::_('COM_BLOG_SELECT_AN_POST') . ' &#8212; ' . $this->getTitle();

            $this->dataAttributes['data-language'] = $language;
        } else {
            $modalTitle = Text::_('COM_BLOG_SELECT_AN_POST');
        }
        ...
        $this->modalTitles['new']     = Text::_('COM_BLOG_NEW_POST');
        $this->modalTitles['edit']    = Text::_('COM_BLOG_EDIT_POST');

        $this->hint = $this->hint ?: Text::_('COM_BLOG_SELECT_AN_POST');
