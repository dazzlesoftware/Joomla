...
namespace Joomla\Component\Blog\Administrator\Button;
...
/**
 * A clickable star toggle for the Categories list, reusing core's own
 ...
 */
final class CategoryDefaultButton extends ActionButton
{
    protected function preprocess()
    {
        ...
        // shows a category is the active default.
        $this->addState(1, 'removedefault', 'icon-star text-warning', Text::_('COM_BLOG_REMOVE_DEFAULT'), ['tip_title' => Text::_('COM_BLOG_DEFAULT_CATEGORY')]);
        $this->addState(0, 'makedefault', 'icon-star-empty', Text::_('COM_BLOG_MAKE_DEFAULT'), ['tip_title' => Text::_('JNO')]);
    }
}
