...
namespace Joomla\Component\Blog\Administrator\Extension;
...
use Joomla\Component\Blog\Administrator\Service\HTML\AdministratorService;
...
/**
 * Component class for com_blog
 *
 * @since  4.0.0
 */
class BlogComponent extends MVCComponent implements
    ...
    TagServiceInterface
{
    ...
    public function boot(ContainerInterface $container)
    {
        ...
        $this->getRegistry()->register('blogadministrator', new AdministratorService());
        $this->getRegistry()->register('blogicon', new Icon());

        // The layout joomla.content.icons does need a general icon service
        $this->getRegistry()->register('icon', $this->getRegistry()->getService('blogicon'));
    }
