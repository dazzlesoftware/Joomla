...
final class SubscriberController extends BaseController
{
    public function save(): void
    {
        ...
        if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            $app->redirect(Route::_('index.php?option=com_blog&view=subscriber&id=' . $id, false));
            return;
        }
        ...
        $app->redirect(Route::_('index.php?option=com_blog&view=subscribers', false));
    }
