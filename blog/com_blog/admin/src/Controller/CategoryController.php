...
use Joomla\CMS\Factory; use Joomla\CMS\MVC\Controller\BaseController; use Joomla\CMS\Router\Route; use Joomla\CMS\Session\Session; use Joomla\Component\Blog\Administrator\Helper\CategoriesHelper;
...
final class CategoryController extends BaseController
{
    ...
    {
        $id = $this->doSave();
        Factory::getApplication()->redirect(Route::_('index.php?option=com_blog&view=category&id=' . $id, false));
    }

    public function save(): void
    {
        $this->doSave();
        Factory::getApplication()->redirect(Route::_('index.php?option=com_blog&view=categories', false));
    }
