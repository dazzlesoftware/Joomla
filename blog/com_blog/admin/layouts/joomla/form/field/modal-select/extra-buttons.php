...
$wa->addInlineScript(
    'window.jSelectPost_' . $id . ' = function (id, title, catid, object, url, language) {
  window.processModalSelect("Post", "' . $id . '", id, title, catid, object, url, language);
}',
    ['name' => 'inline.select_post_' . $id],
    ['type' => 'module']
);
...
$callbackFunctionStem = substr("jSelectPost_" . $id, 0, -$tagLength);
