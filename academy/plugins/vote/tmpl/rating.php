 ...
 * @var \Joomla\Plugin\Academy\Vote\Extension\Vote $this
 */
$wa = $this->getApplication()->getDocument()->getWebAssetManager();
$wa->registerAndUseStyle('plg_academy_vote', 'plg_academy_vote/rating.css');
...
if ($context === 'com_academy.categories') {
    return;
}

// Get the icons
$iconStar     = HTMLHelper::_('image', 'plg_academy_vote/vote-star.svg', '', '', true, true);
$iconHalfstar = HTMLHelper::_('image', 'plg_academy_vote/vote-star-half.svg', '', '', true, true);
