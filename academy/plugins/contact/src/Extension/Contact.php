...
namespace Joomla\Plugin\Academy\Contact\Extension;
...
final class Contact extends CMSPlugin implements SubscriberInterface
{
    ...
    public function onContentPrepare(ContentPrepareEvent $event)
    {
        ...
        $allowed_contexts = ['com_academy.category', 'com_academy.post', 'com_academy.featured'];
        ...
        // Return if we don't have a valid post id
     ...
     * Retrieve Contact
     *
     * @param   int  $userId  Id of the user who created the post
     *
