...
namespace Joomla\Plugin\Academy\Fieldsbutton\Extension;
...
final class Fields extends CMSPlugin implements SubscriberInterface
{
    ...
    public function onDisplay($name)
    {
        ...
        // Special context for com_academy
        if ($context === 'com_academy.category') {
            $context = $jinput->get('extension', 'com_academy') . '.categories';
        }
        ...
        $button = new Button(
            ...
            [
                'action'  => 'modal',
                'link'    => $link,
                'text'    => Text::_('PLG_ACADEMY_FIELDSBUTTON_BUTTON_FIELD'),
                'icon'    => 'puzzle',
