...
namespace Joomla\Plugin\Academy\Confirmconsent\Field;
...
class ConsentBoxField extends CheckboxesField
{
    ...
    private function getAssignedPostUrl()
    {
        ...
        try {
            ...
            return Route::_(
                'index.php?option=com_academy&view=post&id='
        ...
        $associatedPosts = Associations::getAssociations('com_academy', '#__academy', 'com_academy.item', $post->id);
