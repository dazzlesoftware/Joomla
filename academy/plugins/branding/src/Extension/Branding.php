<?php
namespace Joomla\Plugin\System\AcademyBranding\Extension;
...
final class Branding extends CMSPlugin implements SubscriberInterface
{
    ...
    {
        if (!$this->getApplication()->isClient('site') || $this->getApplication()->getInput()->getCmd('option') !== 'com_academy') return;
