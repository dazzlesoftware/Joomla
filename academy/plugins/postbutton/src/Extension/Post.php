...
namespace Joomla\Plugin\Academy\Postbutton\Extension;
...
final class Post extends CMSPlugin implements SubscriberInterface
{
    ...
    public function onDisplay($name)
    {
        ...
        $canCreateRecords = $user->authorise('core.create', 'com_academy')
            || \count($user->getAuthorisedCategories('com_academy', 'core.create')) > 0;

        // Instead of checking edit on all records, we can use **same** check as the form editing view
        $values           = (array) $this->getApplication()->getUserState('com_academy.edit.post.id');
        ...
        $link = 'index.php?option=com_academy&view=posts&layout=modal&tmpl=component&'
