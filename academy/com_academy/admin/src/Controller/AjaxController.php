...
/**
 * The post controller for ajax requests
 *
 * @since  3.9.0
 */
class AjaxController extends BaseController
{
    ...
    public function fetchAssociations()
    {
        if (!Session::checkToken('get')) {
            ...
            $associations = Associations::getAssociations('com_academy', '#__academy', 'com_academy.item', (int) $assocId);

            unset($associations[$excludeLang]);

            // Add the title to each of the associated records
            $contentTable = new PostTable(Factory::getDbo());
