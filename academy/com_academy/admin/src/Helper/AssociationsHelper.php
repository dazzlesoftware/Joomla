...
class AssociationsHelper extends AssociationExtensionHelper
{
     ...
     * @since   3.7.0
     */
    protected $itemTypes = ['post', 'category'];
    ...
    public function getItem($typeName, $id)
    {
        ...
        switch ($typeName) {
            case 'post':
                $table = new PostTable(Factory::getDbo());
                break;
        ...
        if (\in_array($typeName, $this->itemTypes)) {
            switch ($typeName) {
                ...
                case 'category':
                    ...
                    // native #__academy_categories table has no checked_out /
