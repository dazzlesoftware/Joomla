...
final class CategoryDefaultButton extends ActionButton
{
    protected function preprocess()
    {
        ...
        $this->addState(1, 'removedefault', 'icon-star text-warning', Text::_('COM_ACADEMY_REMOVE_DEFAULT'), ['tip_title' => Text::_('COM_ACADEMY_DEFAULT_CATEGORY')]);
        $this->addState(0, 'makedefault', 'icon-star-empty', Text::_('COM_ACADEMY_MAKE_DEFAULT'), ['tip_title' => Text::_('JNO')]);
    }
}
