...
final class HtmlView extends BaseHtmlView
{
    ...
    public array $sections = [
        ...
        'lists' => ['label' => 'Post Lists & Blog Layouts', 'icon' => 'list', 'fieldsets' => ['list_display', 'listing_filters', 'blog_default_parameters', 'compact_posts', 'list_default_parameters', 'shared']],
