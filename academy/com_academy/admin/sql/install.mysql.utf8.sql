...
CREATE TABLE IF NOT EXISTS `#__academy_poll_options` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__academy_poll_votes` (
...
CREATE TABLE IF NOT EXISTS `#__academy_rating_votes` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `post_id` int unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__academy_subscribers` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__academy_subscriber_suppressions` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `email` varchar(320) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__academy_import_batches` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__academy_import_items` (
...
CREATE TABLE IF NOT EXISTS `#__academy_email_templates` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__academy_campaigns` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `subject` varchar(255) NOT NULL,
  `body` mediumtext NOT NULL,
  `state` tinyint NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `#__academy_mail_queue` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__academy_autopost_logs` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `post_id` int unsigned NOT NULL,
