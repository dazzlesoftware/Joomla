...
<form action="<?php echo Route::_('index.php?option=com_academy&view=subscribers'); ?>" method="get" class="row g-2 mb-3">
    ...
    <div class="col-auto"><a class="btn btn-secondary" href="<?php echo Route::_('index.php?option=com_academy&view=subscribers'); ?>">Clear</a></div>
</form>

<div class="d-flex flex-wrap gap-2 mb-3">
    <a class="btn btn-success" href="<?php echo Route::_('index.php?option=com_academy&task=subscribers.export'); ?>">Export CSV</a>
    <form action="<?php echo Route::_('index.php?option=com_academy&task=subscribers.import'); ?>" method="post" enctype="multipart/form-data" class="d-flex gap-2">
            ...
            <tbody>
                <?php foreach ($this->items as $i => $item) : ?>
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo Route::_('index.php?option=com_academy&view=subscriber&id=' . (int) $item->id); ?>"><?php echo $escape($item->name !== '' ? $item->name : $item->email); ?></a></td>
