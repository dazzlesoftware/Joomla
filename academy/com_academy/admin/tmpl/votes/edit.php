...
?>
<form action="<?php echo Route::_('index.php?option=com_academy'); ?>" method="post" id="vote-form">
    ...
    <a class="btn btn-outline-secondary" href="<?php echo Route::_('index.php?option=com_academy&view=votes'); ?>">Cancel</a>
