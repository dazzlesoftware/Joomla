...
use Joomla\Component\Academy\Administrator\Button\CategoryDefaultButton;
            ...
            <table class="table table-hover" id="categoryList">
                ...
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="w-5 text-center">
                            <?php echo HTMLHelper::_('searchtools.sort', 'COM_ACADEMY_HEADING_DEFAULT', 'c.is_default', $this->listDirn, $this->listOrder); ?>
                        </th>
                        <th scope="col" class="w-5 text-center">
                ...
                <?php foreach ($this->items as $i => $item) : ?>
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <td class="text-center">
                            <?php
                            $defaultOptions = ['task_prefix' => 'categories.', 'disabled' => !$this->getCurrentUser()->authorise('core.edit.state', 'com_academy'), 'id' => 'cat-default-' . $item->id];
