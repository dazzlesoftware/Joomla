            ...
            <div class="post-editor-writing" data-post-editor-column>
                ...
                <div>
                    <fieldset class="adminform">
                        <?php $pollDb = Factory::getContainer()->get(DatabaseInterface::class); $pollItems = $pollDb->setQuery($pollDb->createQuery()->select(['id','title'])->from('#__academy_polls')->where('state=1')->order('title'))->loadObjectList(); ?>
