...
/** @var \Joomla\Component\Academy\Administrator\View\Post\HtmlView $this */

defined('_JEXEC') or die;
\Joomla\Component\Academy\Administrator\Helper\NeuralNetworkEditorHelper::load();
...
$wa->registerAndUseStyle('com_academy.post-editor', 'com_academy/admin-post-editor.css', ['version' => '1.0.3']);
$wa->registerAndUseScript('com_academy.post-editor', 'com_academy/admin-post-editor.js', ['version' => '1.0.2'], ['type' => 'module']);
$wa->getRegistry()->addExtensionRegistryFile('com_contenthistory');
$wa->registerAndUseScript('com_academy.block-editor', 'com_academy/admin-block-editor.js', ['version' => '1.4.1'], ['type' => 'module'])
    ->registerAndUseStyle('com_academy.block-editor', 'com_academy/admin-block-editor.css', ['version' => '1.4.1']);
...
$tmpl    = $tmpl ? '&tmpl=' . $tmpl : '';
?>
<form action="<?php echo Route::_('index.php?option=com_academy&layout=' . $layout . $tmpl . '&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" aria-label="<?php echo Text::_('COM_ACADEMY_FORM_TITLE_' . ((int) $this->item->id === 0 ? 'NEW' : 'EDIT'), true); ?>" class="form-validate">
    <div class="post-editor-workspace">
        <div class="post-editor-heading">
            <span class="post-editor-eyebrow"><?php echo Text::_('COM_ACADEMY_EDITOR_WRITING'); ?></span>
            <div class="post-editor-actions">
                <a href="#post-advanced" class="btn btn-link" data-post-advanced-link><?php echo Text::_('COM_ACADEMY_EDITOR_ADVANCED'); ?></a>
                <button type="button" class="btn btn-outline-secondary" data-post-focus aria-pressed="false" aria-controls="post-settings" hidden><?php echo Text::_('COM_ACADEMY_EDITOR_FOCUS'); ?></button>
            </div>
        </div>
        <div class="post-editor-grid">
            <div class="post-editor-writing" data-post-editor-column>
                <div class="post-editor-title form-vertical">
                    <?php $this->form->setFieldAttribute('title', 'hint', 'COM_ACADEMY_EDITOR_TITLE_HINT'); ?>
                    ...
                    <fieldset class="adminform">
                        ...
                        <details class="post-editor-excerpt" <?php echo trim((string) $this->form->getValue('excerpt')) !== '' ? 'open' : ''; ?>>
                            ...
                            <div class="post-editor-panel-body form-vertical">
                                ...
                                <p class="post-editor-hint"><?php echo Text::_('COM_ACADEMY_FIELD_EXCERPT_DESC'); ?></p>
                            </div>
                        </details>
                        <div data-post-block-editor data-editor-id="jform_post_content" data-default-mode="<?php echo htmlspecialchars(ComponentHelper::getParams('com_academy')->get('default_editor_mode', 'classic'), ENT_QUOTES, 'UTF-8'); ?>" data-polls="<?php echo htmlspecialchars(json_encode($pollItems), ENT_QUOTES, 'UTF-8'); ?>">
            ...
            <aside class="post-editor-settings" id="post-settings" aria-label="<?php echo Text::_('COM_ACADEMY_EDITOR_SETTINGS'); ?>" data-post-global-column>
                <h2><?php echo Text::_('COM_ACADEMY_EDITOR_SETTINGS'); ?></h2>
                <details class="post-editor-panel">
                    <summary><?php echo Text::_('COM_ACADEMY_EDITOR_VISIBILITY'); ?></summary>
                    <div class="post-editor-panel-body form-vertical">
                        <?php echo $this->form->renderField('alias'); ?>
                        <?php $this->fields = ['access', 'language']; ?>
                        <?php echo LayoutHelper::render('academy.edit.global', $this); ?>
                    </div>
                </details>
                <details class="post-editor-panel" open>
                    <summary><?php echo Text::_('COM_ACADEMY_EDITOR_PUBLISH'); ?></summary>
                    ...
                    <details class="post-editor-panel" open>
                        ...
                        <div id="fieldset-image-featured" class="post-editor-panel-body form-vertical">
                            ...
                            <details class="post-editor-image-options">
                                <summary><?php echo Text::_('COM_ACADEMY_EDITOR_IMAGE_DETAILS'); ?></summary>
                ...
                <details class="post-editor-panel">
                    <summary><?php echo Text::_('COM_ACADEMY_EDITOR_NOTES'); ?></summary>
                    <div class="post-editor-panel-body">
        ...
        <summary><?php echo Text::_('COM_ACADEMY_EDITOR_ADVANCED'); ?><span><?php echo Text::_('COM_ACADEMY_EDITOR_ADVANCED_HINT'); ?></span></summary>
        <div class="main-card">
        <?php echo HTMLHelper::_('uitab.startTabSet', 'myTab', ['recall' => true, 'breakpoint' => 768]); ?>
        <?php echo LayoutHelper::render('academy.edit.params', $this); ?>

        <?php // Do not show the publishing options if the edit form is configured not to.?>
        <?php if ($params->get('show_publishing_options', 1) == 1) : ?>
            <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'publishing', Text::_('COM_ACADEMY_FIELDSET_PUBLISHING')); ?>
            <div class="row">
                <div class="col-12 col-lg-6">
                    <fieldset id="fieldset-publishingdata" class="options-form">
                        <legend><?php echo Text::_('JGLOBAL_FIELDSET_PUBLISHING'); ?></legend>
                        <div>
                        <?php echo LayoutHelper::render('academy.edit.publishingdata', $this); ?>
                        </div>
                    </fieldset>
                </div>
                <div class="col-12 col-lg-6">
                    <fieldset id="fieldset-metadata" class="options-form">
                        ...
                        <div>
                        <?php echo LayoutHelper::render('academy.edit.metadata', $this); ?>
                        </div>
                    </fieldset>
                </div>
            </div>
        ...
        <?php if (!$isModal && $assoc && $params->get('show_associations_edit', 1) == 1) : ?>
            ...
            <div>
            <?php echo LayoutHelper::render('academy.edit.associations', $this); ?>
            </div>
            </fieldset>
            <?php echo HTMLHelper::_('uitab.endTab'); ?>
        <?php elseif ($isModal && $assoc) : ?>
            <div class="hidden"><?php echo LayoutHelper::render('academy.edit.associations', $this); ?></div>
        <?php endif; ?>

        <?php if ($this->canDo->get('core.admin') && $params->get('show_configure_edit_options', 1) == 1) : ?>
            <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'editor', Text::_('COM_ACADEMY_SLIDER_EDITOR_CONFIG')); ?>
            <fieldset id="fieldset-editor" class="options-form">
                <legend><?php echo Text::_('COM_ACADEMY_SLIDER_EDITOR_CONFIG'); ?></legend>
                <div class="form-grid">
        ...
        <?php if ($this->canDo->get('core.admin') && $params->get('show_permissions', 1) == 1) : ?>
            <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'permissions', Text::_('COM_ACADEMY_FIELDSET_RULES')); ?>
            <fieldset id="fieldset-rules" class="options-form">
                <legend><?php echo Text::_('COM_ACADEMY_FIELDSET_RULES'); ?></legend>
                <div>
