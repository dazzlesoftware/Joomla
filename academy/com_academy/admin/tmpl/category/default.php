            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="mb-0 form-check form-switch">
                        ...
                        >
                        <label class="form-check-label" for="jform_is_default"><?php echo Text::_('COM_ACADEMY_FIELD_CATEGORY_DEFAULT_LABEL'); ?></label>
                        <div class="form-text"><?php echo Text::_('COM_ACADEMY_FIELD_CATEGORY_DEFAULT_DESC'); ?></div>
                    </div>
                </div>
            </div>
            <div class="card">
