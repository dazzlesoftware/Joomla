...
class FeaturedModel extends PostsModel
{
    ...
    protected function populateState($ordering = null, $direction = null)
    {
        ...
        $limit = $params->get('num_leading_posts') + $params->get('num_intro_posts') + (\Joomla\Component\Academy\Site\Helper\CompactPostsHelper::visible($params) && $params->get('compact_selection', 'next') === 'next' ? $params->get('num_links') : 0);
