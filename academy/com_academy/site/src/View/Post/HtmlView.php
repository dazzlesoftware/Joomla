...
namespace Joomla\Component\Academy\Site\View\Post;
...
use Joomla\Component\Academy\Site\Model\PostModel;
...
class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null)
    {
        ...
        $item->tags->getItemTags('com_academy.post', $this->item->id);
        ...
        PluginHelper::importPlugin('academy', null, true, $dispatcher);

        $contentEventArguments = [
            'context' => 'com_academy.post',
            'subject' => $item,
            'params'  => $item->params,
            'page'    => $offset,
        ];
    ...
    protected function _prepareDocument()
    {
        ...
        if (!$this->menuItemMatchPost) {
            ...
            if (
                $menu && $menu->component == 'com_academy' && isset($menu->query['view'])
            ...
            $category = Factory::getContainer()->get(\Joomla\Database\DatabaseInterface::class)->setQuery('SELECT id,title,language FROM #__academy_categories WHERE id=' . (int) $this->item->catid)->loadObject();
        ...
        \Joomla\Component\Academy\Site\Helper\SeoHelper::apply($this->getDocument(), $this->item);
