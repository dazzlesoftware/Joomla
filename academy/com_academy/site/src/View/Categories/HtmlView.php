...
final class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null): void
    {
        ...
        $this->params = \Joomla\Component\Academy\Site\Helper\ListExcerptHelper::settings($app->getParams());
        ...
        $tree = \Joomla\Component\Academy\Site\Helper\SubcategoriesHelper::load($parentId, $treeParams, true);
        $this->items = [];
        ...
        $this->baseDescription = $parentId > 0 ? (string) $db->setQuery(
            $db->createQuery()->select('description')->from('#__academy_categories')->where('id=' . $parentId)
