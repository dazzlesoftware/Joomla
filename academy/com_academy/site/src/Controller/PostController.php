...
class PostController extends FormController
{
    ...
    protected function allowAdd($data = [])
    {
        ...
        if ($categoryId) {
            ...
            $allow = $user->authorise('core.create', 'com_academy.category.' . $categoryId);
        }
    ...
    protected function allowEdit($data = [], $key = 'id')
    {
        ...
        if ($user->authorise('core.edit', 'com_academy.post.' . $recordId)) {
            return true;
        }

        // Check edit own on the record asset (explicit or inherited)
        if ($user->authorise('core.edit.own', 'com_academy.post.' . $recordId)) {
    ...
    public function vote()
    {
        ...
        if ($user_rating > -1) {
            ...
            if ($model->storeVote($id, $user_rating)) {
                $this->setRedirect($url, Text::_('COM_ACADEMY_POST_VOTE_SUCCESS'));
            } else {
                $this->setRedirect($url, Text::_('COM_ACADEMY_POST_VOTE_FAILURE'));
            }
        }
    }
}
