...
/** @var \Joomla\Component\Academy\Site\View\Form\HtmlView $this */
/** @var Joomla\CMS\WebAsset\WebAssetManager $wa */
$wa = $this->getDocument()->getWebAssetManager();
$wa->useScript('keepalive')
    ->useScript('form.validate')
    ->useScript('com_academy.form-edit');
...
<div class="edit item-page">
    ...
    <form action="<?php echo Route::_('index.php'); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-vertical">
        <fieldset>
            ...
            <?php echo HTMLHelper::_('uitab.addTab', $this->tab_name, 'editor', Text::_('COM_ACADEMY_POST_CONTENT')); ?>
            ...
            <?php echo HTMLHelper::_('uitab.addTab', $this->tab_name, 'options', Text::_('JOPTIONS')); ?>
                <?php echo $this->form->renderField('transition'); ?>
                    ...
                    <?php if (empty($this->item->id)) : ?>
                        <p class="alert alert-info"><?php echo \Joomla\CMS\Language\Text::_('COM_ACADEMY_FRONTEND_REVIEW_NOTICE'); ?></p>
                    <?php endif; ?>
                    ...
                    <?php if (is_null($this->item->id)) : ?>
                        <div class="control-group">
                            <div class="controls">
                                <?php echo Text::_('COM_ACADEMY_ORDERING'); ?>
                            </div>
                        </div>
                    <?php endif; ?>
                <?php echo HTMLHelper::_('uitab.endTab'); ?>
                ...
                <?php if ($params->get('show_publishing_options', 1) == 1) : ?>
                    <?php echo HTMLHelper::_('uitab.addTab', $this->tab_name, 'publishing', Text::_('COM_ACADEMY_PUBLISHING')); ?>
                        <?php if ($this->item->params->get('access-change')) : ?>
                        ...
                        <fieldset id="fieldset-metadata" class="options-form">
                            <legend><?php echo Text::_('COM_ACADEMY_METADATA'); ?></legend>
