...
<div class="item-content">
    ...
    <?php if ($params->get('show_title')) : ?>
        <h2 class="item-title d-flex align-items-center gap-2"><?php if (!in_array($listStyle, ['card', 'learning'], true)) { echo LayoutHelper::render('postlist.' . $listStyle . '.avatar', $this->item, JPATH_COMPONENT . '/layouts'); } ?><span>
