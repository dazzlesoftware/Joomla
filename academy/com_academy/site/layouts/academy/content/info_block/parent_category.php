...
<dd class="parent-category-name">
    <?php echo LayoutHelper::render('academy.icon.iconclass', ['icon' => 'icon-folder icon-fw']); ?>
    ...
    <?php if ($displayData['params']->get('link_parent_category') && !empty($displayData['item']->parent_id)) : ?>
        <?php $url = '<a href="' . Route::_(
            ...
            . '">' . $title . '</a>'; ?>
        <?php echo Text::sprintf('COM_ACADEMY_PARENT', $url); ?>
    <?php else : ?>
        <?php echo Text::sprintf('COM_ACADEMY_PARENT', '<span>' . $title . '</span>'); ?>
    <?php endif; ?>
</dd>
