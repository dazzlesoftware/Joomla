...
$profileUrl = Route::_('index.php?option=com_academy&view=author&id=' . $authorId);
...
$model = $app->bootComponent('com_academy')->getMVCFactory()->createModel('Posts', 'Site', ['ignore_request' => true]);
            ...
            <ul class="list-unstyled mb-0">
                <?php foreach ($posts as $post) : ?>
                    <li class="d-flex flex-wrap justify-content-between align-items-baseline gap-2 border-top py-3">
                        ...
                        <?php echo \Joomla\Component\Academy\Site\Helper\DateHelper::render($post, $post->params ?? null, false); ?>
                    </li>
                <?php endforeach; ?>
            </ul>
        <?php else : ?>
