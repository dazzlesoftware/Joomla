...
if (!$items || !\Joomla\Component\Academy\Site\Helper\CompactPostsHelper::visible($params)) { return; }
Factory::getApplication()->getDocument()->getWebAssetManager()->useStyle('fontawesome')
    ->registerAndUseStyle('com_academy.compact-posts', 'com_academy/compact-posts.css', ['version' => 'auto']);
