...
$isGuest = $user->guest;
$canCreatePost = \Joomla\Component\Academy\Site\Helper\SubmissionHelper::hasAccess($user) && $user->authorise('core.create', 'com_' . $family);

// Without an Itemid, Joomla's SEF router has no menu item to build a
// friendly path from and falls back to the raw "component/academy" URL
